...
const TrackingInputCard = React.memo(({ goal, index, activeQuarter, localAchievement, onLocalChange, onSave, isSaving }) => {
  ...
  return (
    <div className="p-3 sm:p-5 mb-3 sm:mb-4 border border-gray-200 rounded-xl bg-gray-50 hover:border-indigo-200 transition-colors">
      <div className="flex flex-col lg:flex-row gap-6">
        ...
        <div className="flex-1 space-y-4">
          <div className="flex items-center space-x-3">
            ...
            <h3 className="text-sm sm:text-base font-semibold text-gray-800">{goal.title}</h3>
            {goal.isShared && (
            ...
            <div className="space-y-4">
              <div>
                ...
                <input 
                  ...
                  className="text-black w-full px-3 py-2 text-sm border border-gray-300 rounded-md focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-all bg-gray-50 focus:bg-white"
                />
                ...
                {['Numeric_Min', 'Percentage_Min', 'Numeric_Max', 'Percentage_Max'].includes(goal.uomType) && !isNaN(Number(goal.target)) && (
                  <div className="mt-3">
                    <input 
                      ...
                      onChange={(e) => setActualAchievement(e.target.value)}
                      onBlur={(e) => handleBlur('actualAchievement', e.target.value)}
                      className="text-black w-full h-2 bg-indigo-100 rounded-lg appearance-none cursor-pointer accent-indigo-600 transition-all"
                    />
              ...
              <div>
                ...
                <select 
                  ...
                  className="text-black w-full px-3 py-2 text-sm border border-gray-300 rounded-md focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 bg-gray-50 focus:bg-white cursor-pointer"
                >
              ...
              <button
                ...
                disabled={isSaving}
                className="w-full sm:w-auto mt-2 px-3 py-1.5 sm:px-4 sm:py-2 bg-indigo-600 text-white text-xs sm:text-sm font-medium tracking-wide rounded-lg hover:bg-indigo-700 disabled:opacity-50 transition-all duration-200"
              >
  ...
  return (
    <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-4 sm:p-6">
      <div className="flex justify-between items-center mb-6 border-b border-gray-100 pb-4">
        <div>
          <h1 className="text-lg sm:text-xl lg:text-2xl font-bold tracking-tight text-gray-800">Quarterly Tracking</h1>
          <p className="text-xs sm:text-sm text-gray-500 leading-relaxed mt-1">Log your achievements and track execution progress.</p>
        </div>
      ...
      <div className="flex overflow-x-auto whitespace-nowrap scrollbar-none space-x-1 mb-8 bg-gray-100 p-1.5 rounded-xl border border-gray-200">
